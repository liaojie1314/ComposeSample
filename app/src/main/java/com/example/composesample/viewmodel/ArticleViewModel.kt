...
import com.example.composesample.model.entity.ArticleEntity
import com.example.composesample.model.service.ArticleService
...
//    var list1 = mutableStateListOf<String>()
    ...
    //第一页文章列表数据是否加载完成
    var listLoaded by mutableStateOf(
        false
    )
        private set
...
//        list1.add("1")
        val res = articleService.list(pageSize = pageSize, pageOffset = pageOffset)
