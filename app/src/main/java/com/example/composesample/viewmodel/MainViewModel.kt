...
import com.example.composesample.model.entity.Category
import com.example.composesample.model.entity.DataType
import com.example.composesample.model.entity.SwiperEntity
import com.example.composesample.model.service.HomeService
...
//            SwiperEntity("https://docs.bughub.icu/compose/assets/banner4.jpg"),
    ...
    var swiperLoaded by mutableStateOf(
        false
    )
        private set
